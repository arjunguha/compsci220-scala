...
\begin{enumerate}
  ...
  For example, \scalainline{removeAlternating(List("A", "B"))} should be
  \scalainline{List("A")} and not \scalainline{List("B")}.
  ...
  \scalainline{List[Int]} and produces a \scalainline{Int}. The produced
  ...
  For example, \scalainline{alternate(List(1, 3, 5), List(2, 4, 6))} should
  be \scalainline{List(1, 2, 3, 4, 5, 6)}.
  ...
  For example, \scalainline{fromTo(9, 13)} should be \scalainline{List(9, 10, 11, 12)}
  and \scalainline{fromTo(10, 10)} should be \scalainline{Nil}.
