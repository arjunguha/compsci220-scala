...
For example, given \scalainline{List(Duck, Duck, Goose)}, your program should produce \scalainline{List("dog food", "dog food", "pate")}.  As this is just an in-class exercise, no actual ducks or geese should be harmed.

\section{Exercise \#2}

\emph{Your task}: Write a ScalaTest (consult your notes from Lecture \#1) that tests that your function really does convert \scalainline{List(Duck, Duck, Goose)} into \scalainline{List("dog food", "dog food", "pate")}.
